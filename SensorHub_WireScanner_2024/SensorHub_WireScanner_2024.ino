...
// Nov 5, 2021 J.A. Korten
// Scanner for 3 i2c channels:
// Especially for DevBoard for Ventilations / Soft Robotics actuators.
//
//
// Version for SAMD21 boards
// 
...
void printDeviceName(int address) {
  ...
  if (address == 0x25) {
    Serial.println("Sensirion SDP8xx-500Pa found...");
  }
  if (address == 0x26) {
    Serial.println("Sensirion SDP8xx-501Pa found...");
  }
  if (address == 0x29) {
